// App-owned trust content for Vuneli. Maintained by the app owner (Verde IQ,
...
const CONTENT: Record<Locale, Record<TrustPageKey, TrustPageContent>> = {
  en: {
    privacy: {
      ...
      intro:
        "This Privacy Policy explains what personal data Vuneli collects, why we collect it, and the rights you have under the EU General Data Protection Regulation (GDPR) and the Cyprus Data Protection Law (Law 125(I)/2018).",
      ...
      sections: [
        ...
        },
        {
          ...
          list: [
            ...
            "Billing data: subscription plan, payment status and invoice metadata (card details are handled by Stripe — Vuneli never sees full card numbers).",
        ...
        },
        {
          heading: "Cookies",
          body: [
            "Vuneli uses strictly-necessary cookies for authentication and language preference (no consent required under ePrivacy) and optional analytics cookies only after you accept the cookie banner. You can change your choice at any time from the footer.",
          ],
        },
        {
          heading: "Contact",
    ...
    terms: {
      ...
      intro:
        "These Terms govern your use of Vuneli. By creating an account you agree to them. Cyprus law applies and the courts of Nicosia have exclusive jurisdiction, without prejudice to consumer rights under EU law.",
      lastUpdated: LAST_UPDATED_EN,
      ownerNote: OWNER_EN,
      sections: [
        {
          heading: "The service",
          body: [
            "Vuneli is an AI-assisted sustainability platform for SMEs. Outputs (emissions estimates, reports, benchmarks) are informational and do not constitute regulatory, legal, or audit-grade assurance. You are responsible for verifying figures before submitting them to authorities.",
          ],
        },
        {
  ...
  el: {
    privacy: {
      ...
      intro:
        "Η παρούσα Πολιτική Απορρήτου εξηγεί ποια προσωπικά δεδομένα συλλέγει το Vuneli, γιατί τα συλλέγουμε και τα δικαιώματά σας βάσει του Γενικού Κανονισμού Προστασίας Δεδομένων (GDPR) και του Κυπριακού Νόμου 125(Ι)/2018.",
      ...
      sections: [
        ...
        },
        {
          ...
          list: [
            ...
            "Δεδομένα χρέωσης: πλάνο συνδρομής, κατάσταση πληρωμών και μεταδεδομένα τιμολογίων (τα στοιχεία κάρτας τα χειρίζονται αποκλειστικά η Stripe — το Vuneli δεν βλέπει ποτέ πλήρεις αριθμούς καρτών).",
        ...
        },
        {
          heading: "Cookies",
          body: [
            "Το Vuneli χρησιμοποιεί απολύτως αναγκαία cookies για ταυτοποίηση και γλώσσα (χωρίς συγκατάθεση, βάσει ePrivacy) και προαιρετικά analytics cookies μόνο μετά την αποδοχή του banner. Μπορείτε να αλλάξετε την επιλογή σας ανά πάσα στιγμή από το footer.",
          ],
        },
        {
          heading: "Επικοινωνία",
    ...
    terms: {
      ...
      title: "Όροι Χρήσης",
      intro:
        "Οι παρόντες Όροι διέπουν τη χρήση του Vuneli. Δημιουργώντας λογαριασμό συμφωνείτε με αυτούς. Εφαρμόζεται το κυπριακό δίκαιο και αποκλειστική δικαιοδοσία έχουν τα δικαστήρια Λευκωσίας, με την επιφύλαξη των καταναλωτικών δικαιωμάτων βάσει του ενωσιακού δικαίου.",
      lastUpdated: LAST_UPDATED_EL,
      ownerNote: OWNER_EL,
      sections: [
        {
          heading: "Η υπηρεσία",
          body: [
            "Το Vuneli είναι μια πλατφόρμα βιωσιμότητας με υποστήριξη AI για ΜμΕ. Τα αποτελέσματα (εκτιμήσεις εκπομπών, αναφορές, benchmarks) είναι πληροφοριακά και δεν αποτελούν κανονιστική, νομική ή ελεγκτική βεβαίωση. Είστε υπεύθυνοι για την επαλήθευση των στοιχείων πριν την υποβολή τους σε αρχές.",
          ],
        },
        {
    ...
    security: {
      ...
      sections: [
        ...
        },
        {
          heading: "Πληρωμές",
          body: [
            "Τα στοιχεία κάρτας δεν φθάνουν ποτέ στους διακομιστές του Vuneli — χειρίζονται από τη Stripe (PCI-DSS Level 1). Τα webhooks επαληθεύονται με HMAC πριν από οποιαδήποτε αλλαγή κατάστασης.",
          ],
        },
        {
