        ...
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            <h2 className="text-2xl md:text-3xl font-bold mb-3 tracking-tight">
              Why Choose <span className="gradient-text">VerdeIQ</span>
            </h2>
            <p className="text-sm text-foreground/70 dark:text-muted-foreground font-light max-w-xl mx-auto">
              Everything you need to lead sustainability in your industry
            </p>
          </motion.div>
      ...
      <section className="relative py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            <h2 className="text-2xl md:text-3xl font-bold mb-3 tracking-tight">
              Power Your <span className="gradient-text">Sustainability</span> Journey
            </h2>
            <p className="text-sm text-foreground/70 dark:text-muted-foreground font-light max-w-xl mx-auto">
              Real-time data and actionable insights to reduce costs and stay compliant
            </p>
          </motion.div>
      ...
      <section className="relative py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            <p className="text-sm text-foreground/70 dark:text-muted-foreground font-light max-w-xl mx-auto">
              A comprehensive platform for learning, action, and leadership
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <motion.div
              ...
              <PremiumCard className="h-full p-5">
                ...
                <h3 className="text-lg font-bold mb-2">AI Learning Center</h3>
                <p className="text-foreground/70 dark:text-muted-foreground leading-relaxed text-xs font-light">
                  Upskill your team with personalized sustainability courses generated by AI from your company's actual performance data.
                </p>
              </PremiumCard>
            </motion.div>
            ...
            <motion.div
              ...
              <PremiumCard className="h-full p-5">
                ...
                <p className="text-foreground/70 dark:text-muted-foreground leading-relaxed text-xs font-light">
                  Fund verified climate projects directly through our marketplace to offset your remaining carbon footprint and track impact.
                </p>
              </PremiumCard>
            </motion.div>
            ...
            <motion.div
              ...
              <PremiumCard className="h-full p-5">
                ...
                <h3 className="text-lg font-bold mb-2">Creative Media Studio</h3>
                <p className="text-foreground/70 dark:text-muted-foreground leading-relaxed text-xs font-light">
                  Generate professional sustainability marketing content using Imagen 4 and Gemini 2.5 Flash, powered by your real metrics.
                </p>
              </PremiumCard>
            </motion.div>
            ...
            <motion.div
              ...
              <PremiumCard className="h-full p-5">
                ...
                <p className="text-foreground/70 dark:text-muted-foreground leading-relaxed text-xs font-light">
                  Compete with industry peers, earn green credits, and climb the ranks of the world's most sustainable SMEs.
                </p>
              </PremiumCard>
            </motion.div>
          </div>
      ...
      <section className="relative py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <motion.div
            ...
            <h2 className="text-2xl md:text-3xl font-bold mb-3 tracking-tight">
              Trusted by <span className="gradient-text">SMEs Worldwide</span>
            </h2>
            <p className="text-sm text-foreground/70 dark:text-muted-foreground font-light">
              Join hundreds of businesses leading the sustainability revolution
            </p>
          </motion.div>
      ...
      <footer className="relative border-t border-border/30 py-8 px-4 mt-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-foreground/80 dark:text-muted-foreground mb-4 text-xs font-light">
            AI-powered sustainability for the modern enterprise
          </p>
          <div className="flex flex-col items-center gap-2 mb-4">
            <p className="text-xs text-foreground/70 dark:text-muted-foreground font-light">
              Contact: <a href="mailto:founder@stauniverse.tech" className="hover:text-primary transition-colors">founder@stauniverse.tech</a>
            </p>
            <p className="text-xs text-foreground/70 dark:text-muted-foreground font-light">
              Powered by <a href="https://stauniverse.tech" target="_blank" rel="noopener noreferrer" className="font-medium hover:text-primary transition-colors">StaUniverse</a>
            </p>
          </div>
          <p className="text-xs text-foreground/60 dark:text-muted-foreground font-light !whitespace-pre-line">© 2025 VerdeIQ. All rights reserved.
          </p>
        </div>
      </footer>
    </div>);
