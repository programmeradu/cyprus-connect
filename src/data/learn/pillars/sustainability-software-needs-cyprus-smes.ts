...
export const sustainabilitySoftwareNeedsCyprusSmes = makePillar({
  ...
  en: {
    ...
    heroEyebrow: "Cyprus Market Focus",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Software must natively format reports according to the EFRAG Voluntary SME (VSME) standard, allowing Cypriot businesses to satisfy buyer questionnaires without complex enterprise reporting requirements."
        ]
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Το λογισμικό πρέπει να διαμορφώνει αυτόματα τις αναφορές κατά το πρότυπο EFRAG VSME."
        ]
      },
      {
      ...
      },
      {
        ...
        body: [
          "Τα εταιρικά δεδομένα κατανάλωσης και παραγωγής πρέπει να προστατεύονται αυστηρά βάσει της ευρωπαϊκής νομοθεσίας GDPR με φιλοξενία εντός ΕΕ."
        ]
      }
    ],
    keyTakeaways: [
