...
- Do not use dot-separated metadata strings as the primary visual treatment (`01 · Interactive tool`, `Progress · 3/4`, `Sources · ...`) unless styled as deliberate editorial UI with strong weight and readable size.
